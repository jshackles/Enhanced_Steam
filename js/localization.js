    ...
    localization_promise = (function () {
        ...
        localized_strings = {
            ...
            "tur": {
			    ...
			    remove_owned_wishlist: "Sahip Olunanları İstek Listesinden Çıkar",
                ...
                options_greenlight_banner: "Steam Greenlight banner'ını değiştir",
                ...
                options_about_text: "<a href='http://www.enhancedsteam.com' style='color:#8bc53f;'>Enhanced Steam</a> hakkında:<p>Enhanced Steam Steam web sitesine birçok özellik kazandıran bir Google Chrome uzantısıdır.<p>Bazı özellikler:<ul><li>Sahip olunan oyunları vurgulama</li><li>İstek listesindeki oyunları vurgulama</li><li>Correctly calculating bundle discounts based on games you already own</li><li>Steam'de şu ana kadar ne kadar para harcandığını gösterme</li><li>Oyun sayfasında sahip olunan DLCleri vurgulam</li><li>İstek listesindeki herhangi bir oyun veya DLC ikonu için \"Görüntü bulunamadı\" hatasını düzeltme</li><li>3. parti DLC'ye sahip oyunları gösterme</li></ul><p>Eğer bu uzantıyı yararlı bulduysanız, lütfen bağış yapmayı düşünün.",
                tag: "Etiketle",
                ...
                historical_low: "Tarihsel En Düşük Fiyat",
			    ...
			    games_with_booster: "Güçlendirici Paket düşürmeye uygun __boostergames__ oyun",
