...
function add_community_profile_links() {
	...
	storage.get(function(settings) {
		...
		if (settings.profile_steamtrades) {
		    htmlstr += '<div class="profile_count_link"><a href="https://www.steamtrades.com/user/' + steamID + '" target="_blank"><span class="count_link_label">SteamTrades</span>&nbsp;<span class="profile_count_link_total">';
